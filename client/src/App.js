...
import RoyalFacilities, {
  Events,
} from "./Componenets/RoyalFacilities/RoyalFacilities";
...
import {
  HeritagePhotos,
  StudioPhotos,
} from "./Componenets/Accomodation/ComponetDataUtilities";
    ...
    fetch("/hotel")
      ...
      .then((data) => {
        ...
        document.documentElement.style.setProperty(
          "--CustomBlue",
          data.weblist[0].primaryColor
        );
        document.documentElement.style.setProperty(
          "--textDark",
          data.weblist[0].textDark
        );
        document.documentElement.style.setProperty(
          "--CustomYellow",
          data.weblist[0].secondaryColor
        );
        document.documentElement.style.setProperty(
          "--textLight",
          data.weblist[0].textLight
        );
    ...
    <SkeletonTheme baseColor="#CCCCCC" highlightColor="rgba(0, 0, 0, 0.1)">
      {query.loading ? (
        <>
          ...
          <RoyalFacilities
            amen={
              query.hotelDetails.weblist[0]
                ? query.hotelDetails.weblist[0].amenities
                : ""
            }
          />
          <Events />
          <About
            aboutUS={
              query.hotelDetails.weblist[0]
                ? query.hotelDetails.weblist[0].about
                : ""
            }
          />
          ...
          <Reviews
            Review={
              query.hotelDetails.weblist[0]
                ? query.hotelDetails.weblist[0].reviews
                : ""
            }
            testimonials={
              query.hotelDetails.weblist[0]
                ? query.hotelDetails.weblist[0].testimonials
                : ""
            }
          />
